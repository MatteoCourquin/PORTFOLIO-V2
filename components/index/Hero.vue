  ...
  <div class="hero">
    <div class="hero-description">
      ...
      <nuxt-link to="/contact"
        ><button class="button anim-hero">Contact</button></nuxt-link
      >
    </div>
...
.hero {
  ...
  @include screen-xs {
    ...
    padding: calc(clamp(20px, 4vw, 60px) + clamp(20px, 3.5vw, 60px))
      clamp(20px, 4vw, 60px);
    min-height: 100vh;
  }
  .hero-description {
