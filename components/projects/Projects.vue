      ...
      >
        <div class="project-image">
          ...
          >
            <nuxt-img
              ...
              class="links-img"
              :src="project.image"
              sizes="xs:400 sm:700 md:800 lg:1400 xl:1800"
              alt="projet réalisé par matteo courquin"
            />
          </a>
        </div>
        <div class="project-description">
          ...
          <a
            ...
            target="_blank"
            aria-label="lien vers le projet"
            class="anim-projetcs links links-to-project"
            >voir le projet
            <nuxt-img class="img-links" src="/images/logos/arrow-link.svg"
          /></a>
        </div>
      </div>
